...
class Comment(models.Model):
    ...
    # 评论的用户
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)#User也可以是'users:User'
    # 评论的时间
    created = models.DateTimeField(auto_now_add=True)  # auto_now=timezone.now()
